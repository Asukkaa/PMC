...
import priv.koishi.pmc.finals.enums.ClickTypeEnum;
import priv.koishi.pmc.finals.enums.FindImgTypeEnum;
import priv.koishi.pmc.finals.enums.LanguageEnum;
...
import priv.koishi.pmc.ui.editingcell.EditingCell;
...
public class SettingController extends RootController implements MousePositionUpdater {
     ...
     * 页面标识符
     */
    private static final String tabId = "_Set";

    /**
     * tessdata 组件标识符
     */
    private static final String tessdataId = "_set";
     ...
     */
    private static void findImgTypeAction(ChoiceBox<String> findImgType, HBox regionInfoHBox, HBox regionHBox,
