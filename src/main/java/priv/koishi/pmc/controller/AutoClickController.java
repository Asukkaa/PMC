...
import priv.koishi.pmc.exc.exception.JumpSettingException;
import priv.koishi.pmc.exc.exception.WindowValidationException;
...
import priv.koishi.pmc.ui.editingcell.ItemConsumer;
import priv.koishi.pmc.ui.floatingwindow.FloatingWindow;
...
import static priv.koishi.pmc.exc.ShowException.creatErrorAlert;
...
public class AutoClickController extends RootController implements MousePositionUpdater {
     ...
     * 初始化浮窗
     */
    private static void initFloatingWindow() {
