...
<p>
    ...
    <img alt="GitHub release (latest by date)" src="https://img.shields.io/github/v/release/Asukkaa/PMC?style=for-the-badge&label=PMC&color=blueviolet&logo=github&logoColor=white" />
...
因为当前使用了拓展标题栏这一预览特性，需要开启相应的 JVM 参数: -Djavafx.enablePreview=true ，否则程序无法正常启动。
